...
SpaceInvaders: build/main.o build/game.o build/player.o build/text.o
	$(c++) build/main.o build/game.o build/player.o  build/text.o -o build/SpaceInvaders $(flags) $(libs)
